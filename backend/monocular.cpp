...
// K 相机内参矩阵, p1, p2匹配点坐标, R,T结果的旋转矩阵和平移向量
// mask中大于零的点代表匹配点，等于零代表失配点
bool find_transform(Mat& K, vector<Point2f>& p1, vector<Point2f>& p2, Mat& R, Mat& T, Mat& mask)
{
	//根据内参矩阵获取相机的焦距和光心坐标（主点坐标）
	double focal_length = 0.5*(K.at<double>(0) + K.at<double>(4));   //焦距
	Point2d principle_point(K.at<double>(2), K.at<double>(5));       //光心坐标(x,y)
...
// 获取匹配点对 p1: key_points_all[0], p2: key_points_all[1]
// out_p1: query point out_p2: 对应的train_point
...
// 获取匹配点对 p1: colors_all[0], p2: colors_all[1]
// out_c1: query point颜色 out_c2: 对应的train_point颜色
